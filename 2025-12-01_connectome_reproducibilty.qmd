---
title: "The Replication Situation"
subtitle: "A *very* brief overview of where<br>we're at"
author: '<a href="https://mateusharrington.com/" style="color: #fa2d6e">Gabriel Mateus Bernardo Harrington</a>'
date: '2025-12-08'
...
format: 
  ukdri-revealjs:
    ...
    multiplex: true
    footer: |
        Made with the [UKDRI Quarto template](https://github.com/H-Mateus/quarto-ukdri-theme) by [GMBH](https://mateusharrington.com/).
        Code available on GitHub [here](https://github.com/H-Mateus/presentations_dri-connectome-reproducibility_2025-12-08).
...
# cut down on negative slides to save time
# more time on positive slides - mention good jounrals (not-for-profit like elife/science), explain diamond open access and graph
```
...
#| include: false
code <- qrcode::qr_code(
  "https://h-mateus.github.io/presentations_dri-connectome-reproducibility_2025-12-08/2025-12-01_connectome_reproducibilty.html"
)
...
-   Bayesian statistics is a fundamentally different approach, no ground truth assumptions so no p-values and no p-hacking
...
-   A nice collection of quite egregious high profile fraud in AD research [here](https://moreisdifferent.blog/p/when-weak-links-in-science-matter)[@elton_when_2024]
:::
...
-   Make it [diamond open access](https://www.coalition-s.org/diamond-open-access/) and you can stick it to the evil publishers too!
    -   Check out PCI as an example: [https://rr.peercommunityin.org/](https://rr.peercommunityin.org/)
...
6.  Publish all the things!
    -   Paper, data, code, container of computational environment (Can use [Zenodo](https://zenodo.org/) to generate DOIs for non-paper bits!)
:::
...
## Particular tool suggestions/learning resources
...
## {background-image="images/data_sharing.png" background-size="contain"}

## Training coming somewhere near you soon!

::: columns
::: {.column width="60%"}
- I was awarded the SSI Fellowship 2026 to do some training about version control/code review in the DRI
- Will start with a pilot in Cardiff and then travel around the centers
...
::: columns
::: {.column width="60%"}
- Suvery on knowledge/opions around FAIR data
- Come see us at the ECR Committee Poster in the skills exchange section
:::
...
-   Here's a link to the slides: <https://h-mateus.github.io/presentations_dri-connectome-reproducibility_2025-12-08/2025-12-01_connectome_reproducibilty.html>
:::
...
[![](https://zenodo.org/badge/1108566100.svg)](https://doi.org/10.5281/zenodo.17792781)

![](images/qrcode.svg){.absolute bottom=15 left=250 width="300" height="300"}
